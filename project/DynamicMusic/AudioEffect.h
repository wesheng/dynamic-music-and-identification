...
namespace ws {
	...
	/**
	 * \defgroup AudioEffect
	 * \brief Base class for AudioEffects.
	 * \warning Creating a subclass requires knowledge of working with raw data.
	 */
	class AUDIO_ENGINE AudioEffect
	{
	public:
		AudioEffect() = default;
